...
public class redRightAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d pos2 = new Pose2d(36, -12, Math.toRadians(-90));
        Pose2d pos3 = new Pose2d(13, -12, Math.toRadians(-90));

        Pose2d startPose = new Pose2d(36.7,-65, Math.toRadians(180));
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .back(4)
/*                .setReversed(true)
                .lineToLinearHeading(new Pose2d(-69, -9, Math.toRadians(180)))


                //cycle 3
                //wait a bit so the cone tower doesn't fall
                .addTemporalMarker(() -> {
                    //close claw and go up at cone
                    clawLeft.setPosition(0);
                    clawRight.setPosition(0.5);
