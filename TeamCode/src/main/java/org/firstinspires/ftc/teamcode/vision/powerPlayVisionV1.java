...
public class powerPlayVisionV1 extends OpenCvPipeline {
    ...
    public static Scalar cyanLow = new Scalar(103.4, 154.4, 136.0);
    public static Scalar cyanHigh = new Scalar(255, 255, 255);

    Scalar pinkLow = new Scalar(92, 148.8, 127.4);
    Scalar pinkHigh = new Scalar(218, 160, 179.9);

    Scalar greenLow = new Scalar(99.2, 65.2, 106.3);
    Scalar greenHigh = new Scalar(191.3, 116.8, 195.5);
    ...
    private void doOperations(Mat input) {
        ...
        double [] arr = {40, 100};
        filterContours(buffer,0,0,40,200,40,300, arr, 1000,
